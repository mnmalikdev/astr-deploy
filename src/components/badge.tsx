    ...
    <div className="max-w-sm mt-2 overflow-hidden shadow-lg bg-white rounded-full">
      <div className="h-20">
        <div className="grid grid-cols-5 gap-1 justify-evenly">
          ...
          <div className="h-20 col-span-3 flex items-center">
            <p className="text-dark text-sm text-[#3D4849] px-1" dangerouslySetInnerHTML={{ __html: withBoldedWord }}></p>
          </div>
          <div className="h-20 col-span-1 flex items-center justify-center">
